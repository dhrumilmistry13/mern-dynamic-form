module.exports = {
  async up(queryInterface) {
    ...
    console.log(timezoneDataArray.length);
    let timezoneStoreData = [];
    timezoneDataArray.forEach((value) => {
      value.utc.forEach((val) => {
        timezoneStoreData.push({
          title: value.value.toString(),
          text: value.text.toString(),
          abbr: value.abbr.toString(),
          offset: value.offset.toString(),
          isdst: value.isdst.toString(),
          utc: val.toString(),
          created_at: new Date(),
          updated_at: new Date(),
        });
    ...
    console.log(timezoneStoreData.length);
    timezoneStoreData = timezoneStoreData.reduce((resultArray, item, index) => {
    ...
    return timezoneStoreData.map((v) =>
      queryInterface.bulkInsert('timezones', v)
    );
  },
